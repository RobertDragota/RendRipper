                           ...
                           const Transform& t)
{
    ...
    view_ = glm::lookAt(
            glm::vec3(0.0f, model.radius, dist),
            glm::vec3(0.0f),
    ...
    modelMat_ = glm::translate(glm::mat4(1.0f), t.translation);
    modelMat_ = glm::rotate(modelMat_, glm::radians(t.rotation.x), {1,0,0});
    modelMat_ = glm::rotate(modelMat_, glm::radians(t.rotation.y), {0,1,0});
    modelMat_ = glm::rotate(modelMat_, glm::radians(t.rotation.z), {0,0,1});
    modelMat_ = glm::scale   (modelMat_, glm::vec3(t.scale));
